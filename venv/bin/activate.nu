...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/raresrosu/PycharmProjects/emag-selenium-tests/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/raresrosu/PycharmProjects/emag-selenium-tests/venv/bin/deactivate.nu'
